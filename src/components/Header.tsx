      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              <div className="h-16 w-32 flex items-center justify-center mr-3">
                <img
                  src="/yas-herb-logo.png" 
                  alt="YasHerb Logo"
                  className="h-full w-auto object-contain"
                />
              </div>
              <div className={`font-serif transition-all duration-300 ${scrolled ? "text-green-800" : "text-green-700"}`}>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            <Link href="/contact" className="bg-green-700 hover:bg-green-800 text-white px-5 py-2 rounded-md font-medium transition-colors">
              Get In Touch
            </Link>
          </div>
